...
export class AddCommentsAndRelationshipBetweenUserEntityAndArticleEntity1678293638768
  implements MigrationInterface
{
  name =
    'AddCommentsAndRelationshipBetweenUserEntityAndArticleEntity1678293638768';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE "comments" ("id" SERIAL NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "body" character varying NOT NULL DEFAULT '', "articleId" integer, "authorId" integer, CONSTRAINT "PK_8bf68bc960f2b69e818bdb90dcb" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
